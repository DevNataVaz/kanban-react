		...
		<div className="md:w-[calc(100%-230px)] w-[calc(100%-60px)] fixed flex items-center justify-between pl-2 pr-6 h-[70px] top-0 md:left-[230px] left-[60px] border-b border-slate-300 bg-[#fff]">
			<div className="flex items-center gap-3 cursor-pointer">
				<PersonCircle
					...
					height={"28px"}
				/>
				<span className="text-cyan-900 font-semibold md:text-lg text-sm whitespace-nowrap">
					Lista de Tasks
				</span>
				<ChevronDown
					color="#114d4d"
			...
			<div className="md:flex hidden items-center gap-4">
				...
				<div className="grid place-items-center bg-gray-100 rounded-full transition-transform p-2 cursor-pointer">
